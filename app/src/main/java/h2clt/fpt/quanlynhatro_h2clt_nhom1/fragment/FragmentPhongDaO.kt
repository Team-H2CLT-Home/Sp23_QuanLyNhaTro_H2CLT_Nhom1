...
class FragmentPhongDaO : Fragment() {
    ...
    override fun onCreateView(
        ...
        _binding = FragmentPhongDaOBinding.inflate(LayoutInflater.from(context))
        ...
        listPhong=phongDao.getAllInPhongByMaKhu(maKhu).filter { it.trang_thai_phong==1 }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.rcyPhongDaO.adapter=phongTroAdapter
        binding.rcyPhongDaO.layoutManager= LinearLayoutManager(context)
    }
