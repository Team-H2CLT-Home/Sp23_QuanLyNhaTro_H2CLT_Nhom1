...
import h2clt.fpt.quanlynhatro_h2clt_nhom1.fragment.FragmentHopDongDaHetHan
...
class HopDongPhongHetHanViewHolder(
...
class HopDongPhongHetHanAdapter(val listHopDong: List<HopDong>, val fragment: FragmentHopDongDaHetHan): RecyclerView.Adapter<HopDongPhongHetHanViewHolder>() {
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): HopDongPhongHetHanViewHolder {
        val inflater= LayoutInflater.from(parent.context)
        val binding = LayoutItemDsHopDongBinding.inflate(inflater,parent,false)

        return  HopDongPhongHetHanViewHolder(binding)
    }
    override fun getItemCount()=listHopDong.size
    override fun onBindViewHolder(holder: HopDongPhongHetHanViewHolder, position: Int) {
